...
async function uploadSSHKey(username, password, sshKey) {
  ...
  try {
    ...
    try {
      ...
      await page.$eval('xpath=/html/body/div/div/div/div/div/form/div[1]/input', (el, value) => el.value = value, username);

      log('input', 'Entering password');
      await page.waitForSelector('xpath=/html/body/div/div/div/div/div/form/div[2]/input');
      await page.$eval('xpath=/html/body/div/div/div/div/div/form/div[2]/input', (el, value) => el.value = value, password);
    } catch (error) {
    ...
    try {
      ...
      await page.$eval('xpath=/html/body/div[1]/div/div/div[2]/div/div[1]/div[1]/form/div[1]/input', (el, value) => el.value = value, keyTitle);
      ...
      await page.$eval('xpath=/html/body/div[1]/div/div/div[2]/div/div[1]/div[1]/form/div[2]/textarea', (el, value) => el.value = value, sshKey);
    } catch (error) {
